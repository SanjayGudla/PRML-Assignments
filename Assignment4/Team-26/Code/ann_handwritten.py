...
directories_train = ["./Handwritten/ai/train","./Handwritten/bA/train","./Handwritten/dA/train","./Handwritten/iA/train","./Handwritten/tA/train"]
directories_dev = ["./Handwritten/ai/dev","./Handwritten/bA/dev","./Handwritten/dA/dev","./Handwritten/iA/dev","./Handwritten/tA/dev"]
